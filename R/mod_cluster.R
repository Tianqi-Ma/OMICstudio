  ...
  shiny::moduleServer(id, function(input, output, session) {
    ...
    output$preview <- render_preview_plot(function() {
      ...
      if (!is.null(red)) {
        ...
        return(
          ggplot2::ggplot(df, ggplot2::aes(dim1, dim2, colour = factor(color), text = text)) +
            ...
            ggplot2::scale_colour_manual(values = omicstudio_palette(nlevels(cl)), name = "Cluster / 簇") +
      ...
      ggplot2::ggplot(counts, ggplot2::aes(x = cluster, y = n,
        ...
        ggplot2::geom_col() +
        ggplot2::scale_fill_manual(values = omicstudio_palette(nlevels(counts$cluster)),
                                   guide = "none") +
